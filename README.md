...
The written documentation (Parts I–III) is generated by the `docs/build-*.cjs` scripts into
Word documents and submitted separately, so it is not kept under version control (see `.gitignore`).
